...
static constexpr auto qt_meta_stringdata_StartMenu = QtMocHelpers::stringData(
    "StartMenu",
    "gameRunner",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_StartMenu_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_StartMenu_t qt_meta_stringdata_StartMenu = {
    {
        QT_MOC_LITERAL(0, 9),  // "StartMenu"
        QT_MOC_LITERAL(10, 10),  // "gameRunner"
        QT_MOC_LITERAL(21, 0)   // ""
    },
    "StartMenu",
    "gameRunner",
...
Q_CONSTINIT static const uint qt_meta_data_StartMenu[] = {
...
Q_CONSTINIT const QMetaObject StartMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_StartMenu.offsetsAndSizes,
    qt_meta_data_StartMenu,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_StartMenu_t,
        // Q_OBJECT / Q_GADGET
